...
const defaultTreatment: TreatmentData = {
 ...
 combinations: {
  ...
  combinationLookup: {
    immunotherapy: { coUsage: 42, effectiveness: 78 },
    radiation: { coUsage: 38, effectiveness: 72 },
    surgery: { coUsage: 55, effectiveness: 82 },
    "hormone therapy": { coUsage: 22, effectiveness: 68 },
    "targeted therapy": { coUsage: 28, effectiveness: 75 },
  },
},
  sources: [
    {
